...
public class Engine {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String [] strs = {"-mode","standalone","-jobid","-1","-job",String.format("%s//job//mysql2sqlserver.json", dir)};
    	System.setProperty("datax.home", dir);
//    	System.setProperty("loglevel", "info");
//    	System.setProperty("logback.statusListenerClass", "ch.qos.logback.core.status.NopStatusListener");
//    	System.setProperty("logback.configurationFile", String.format("%s//conf//logback.xml", dir));
    	int exitCode = 0;
        try {
            Engine.entry(strs);
        } catch (Throwable e) {
