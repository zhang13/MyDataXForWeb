...
public final class ConfigParser {
    ...
    public static Configuration parseForJson(final String jobContent) {
    	Configuration config = Configuration.from(jobContent);
        Configuration configuration =  SecretUtil.decryptSecretKey(config);

        return mergeConfiguration(configuration);
    }

	private static Configuration mergeConfiguration(Configuration configuration) {
		configuration.merge(
