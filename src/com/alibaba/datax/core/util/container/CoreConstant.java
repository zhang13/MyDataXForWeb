...
import com.alibaba.datax.core.util.WebRootPath;

/**
 * Created by jingxing on 14-8-25.
 * modify by zhangchao 2016-02-24
 */
...
//	public static String DATAX_HOME = System.getProperty("datax.home");
	public static String DATAX_HOME = new WebRootPath().getWebRootPath()+"/WEB-INF";
	...
	public static String DATAX_CONF_CONVERT_PATH = StringUtils.join(new String[] {
			DATAX_HOME, "conf", "dataTransferConf.properties" }, File.separator);
